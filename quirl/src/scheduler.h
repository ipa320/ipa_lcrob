...
//Direction state
#define STOP			0	// 
#define FORW			1	// straight forward
#define BACK			2	// straight backward 
...
#define HALL_CALIBRATION 1	///< For manual calibration of the Hall Effect Sensors set to 1. Gives serial output of the ADC readings.
...
int16_t vel;
uint8_t poweroff_count;		///< Timer for stop button Power off.
...
uint8_t direction;			//State variable for move direction (STOP, FORW, LEFT, RIGHT, CIRCLE)
uint8_t ButtAct;
