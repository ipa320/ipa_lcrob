...
#define FREE_B4			SBIT(PORTB, 4)		///< Free Pin B4
#define FREE_B3			SBIT(PORTB, 3)		///< Free Pin B3
#define FREE_B2			SBIT(PORTB, 2)		///< Free Pin B2
#define FREE_B1			SBIT(PORTB, 1)		///< Free Pin B1
#define FREE_B0			SBIT(PORTB, 0)		///< Free Pin B0
#define OUTPUTS_B		B(11111111)			///< Port B directions
...
#define FREE_J5			SBIT(PORTJ, 5)		///< Free Pin J5
#define FREE_J4			SBIT(PORTJ, 4)		///< Free Pin J4
#define FREE_J3			SBIT(PORTJ, 3)		///< Free Pin J3
#define FREE_J2			SBIT(PORTJ, 2)		///< Free Pin J2
#define FREE_J1			SBIT(PORTJ, 1)		///< Free Pin J1
