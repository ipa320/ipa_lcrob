...
#define US_SENSOR_TRIGGER			13			///< Threshold reading of the US Sensor for obstacle detection.
...
#define STOP_HALL1					670			///< Hall Sensor 1 ADC reading interpreted as a Hull Stop command.
#define STOP_HALL2_TOP				480			///< Hall Sensor 2 ADC top limit interpreted as a Hull Stop command.
#define STOP_HALL2_BOTTOM			200			///< Hall Sensor 2 ADC bottom limit interpreted as a Hull Stop command.
